    ...
    function showPrice(doble,indv,trip,fam,pro,days) {
        ...
        xmlhttp.onreadystatechange=function() {
            ...
            xmlhttp.open("GET","?page=intranet&action=price&doble=" + doble + "&triple=" + trip + "&ind=" + indv +  "&fam="+fam +"&pro="+pro +"&day="+days,true);
            xmlhttp.send();
