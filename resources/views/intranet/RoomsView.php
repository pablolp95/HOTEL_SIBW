                            ...
                            while($i<=count($rooms)) {
                                echo '<tr>
                                        ...
                                        <td class="center-align">
                                            <a class="btn-floating btn-large waves-effect waves-light deep-orange" href="?page=intranet&section=rooms&action=edit&id={$rooms[$i-1]->get_id()}">
                                                <i class="material-icons">create</i>
                                            </a>
                                            <a class="btn-floating btn-large waves-effect waves-light red" href="?page=intranet&section=rooms&id={$rooms[$i-1]->get_id()}">
                                                <i class="material-icons">visibility</i>
                                            </a>
                                            <a class="btn-floating btn-large waves-effect waves-light blue" href="?page=intranet&section=rooms&action=delete&id={$rooms[$i-1]->get_id()}">
